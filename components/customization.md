...
Components can be customized with the **`theme`** prop or by defining Clerk-specific [CSS variables](https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties). Both ways are described in this guide.
...
![](../.gitbook/assets/clerk-html-starter-1yvjin.stackblitz.io_-2-.png)
{% endtab %}
...
![](../.gitbook/assets/clerk-html-starter-1yvjin.stackblitz.io_-3-.png)
{% endtab %}
...
![](../.gitbook/assets/clerk-html-starter-1yvjin.stackblitz.io_-5-.png)
{% endtab %}
{% endtabs %}
